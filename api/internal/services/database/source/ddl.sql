...
CREATE TABLE IF NOT EXISTS PLANO_DE_ASSINATURA (
    ...
    LIMITE_REDIRECIONADORES INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS USUARIO_KIRVANO (
    ...
    NOME_DE_USUARIO TEXT UNIQUE NOT NULL CHECK(LENGTH(NOME_DE_USUARIO) >= 3 AND LENGTH(NOME_DE_USUARIO) <= 120),
...
CREATE TABLE IF NOT EXISTS EMAIL_AUTENTICACAO (
    ...
    USUARIO_KIRVANO INTEGER NOT NULL,
    FOREIGN KEY(USUARIO_KIRVANO) REFERENCES USUARIO_KIRVANO(ID)
);
...
CREATE TABLE IF NOT EXISTS LINK (
    ...
    NOME TEXT NOT NULL CHECK(LENGTH(NOME) >= 3 AND LENGTH(NOME) <= 120),
    LINK TEXT NOT NULL,
    ATIVO BOOL CHECK(ATIVO IN (0, 1)) DEFAULT 1 NOT NULL,
...
CREATE TABLE IF NOT EXISTS HISTORICO_PLANO_DE_ASSINATURA (
    ...
    NOME TEXT,
    VALOR INTEGER,
    LIMITE_REDIRECIONADORES INTEGER,
...
CREATE TABLE IF NOT EXISTS HISTORICO_REDIRECIONADOR (
    ...
    BITMASK INTEGER,
    _CRIADO_EM TEXT DEFAULT CURRENT_TIMESTAMP NOT NULL,
    FOREIGN KEY(ID) REFERENCES REDIRECIONADOR(ID)
);
