...
BEGIN
    INSERT INTO HISTORICO_PLANO_DE_ASSINATURA(_ROWID, ID, NOME, VALOR_MENSAL, LIMITE_LINKS_MENSAL, ORDENACAO_ALEATORIA_LINKS, CRIADO_EM, ATUALIZADO_EM, REMOVIDO_EM, VERSAO, BITMASK)
    VALUES (NEW.ROWID, NEW.ID, NEW.NOME, NEW.VALOR_MENSAL, NEW.LIMITE_LINKS_MENSAL, NEW.ORDENACAO_ALEATORIA_LINKS, NEW.CRIADO_EM, NEW.ATUALIZADO_EM, NEW.REMOVIDO_EM, 1, 255);
END;
...
BEGIN
    ...
    SELECT OLD.ROWID,
           ...
           CASE WHEN OLD.LIMITE_LINKS_MENSAL != NEW.LIMITE_LINKS_MENSAL THEN NEW.LIMITE_LINKS_MENSAL ELSE NULL END,
           ...
           (CASE WHEN OLD.LIMITE_LINKS_MENSAL != NEW.LIMITE_LINKS_MENSAL THEN 8 ELSE 0 END) +
...
BEGIN
    INSERT INTO HISTORICO_PLANO_DE_ASSINATURA(_ROWID, ID, NOME, VALOR_MENSAL, LIMITE_LINKS_MENSAL, ORDENACAO_ALEATORIA_LINKS, PERIODO_LIMITE, CRIADO_EM, ATUALIZADO_EM, REMOVIDO_EM, VERSAO, BITMASK)
    VALUES (OLD.ROWID, OLD.ID, OLD.NOME, OLD.VALOR_MENSAL, OLD.LIMITE_LINKS_MENSAL, OLD.ORDENACAO_ALEATORIA_LINKS, OLD.CRIADO_EM, OLD.ATUALIZADO_EM, OLD.REMOVIDO_EM, (SELECT COALESCE(MAX(VERSAO), 0) FROM HISTORICO_PLANO_DE_ASSINATURA WHERE _ROWID = OLD.ROWID) + 1, -1);
END;

-- USUARIO_TEMPORARIO

CREATE TRIGGER IF NOT EXISTS USUARIO_TEMPORARIO_INSERIR_HISTORICO
AFTER INSERT ON USUARIO_TEMPORARIO
BEGIN
    INSERT INTO HISTORICO_USUARIO_TEMPORARIO(_ROWID, ID, NOME, NOME_DE_USUARIO, EMAIL, PLANO_DE_ASSINATURA, CRIADO_EM, REMOVIDO_EM, VERSAO, BITMASK)
...
CREATE TRIGGER IF NOT EXISTS USUARIO_TEMPORARIO_ATUALIZAR_HISTORICO
AFTER UPDATE ON USUARIO_TEMPORARIO
FOR EACH ROW
BEGIN
    INSERT INTO HISTORICO_USUARIO_TEMPORARIO(_ROWID, ID, NOME, NOME_DE_USUARIO, EMAIL, PLANO_DE_ASSINATURA, CRIADO_EM, REMOVIDO_EM, VERSAO, BITMASK)
    SELECT OLD.ROWID,
...
CREATE TRIGGER IF NOT EXISTS USUARIO_TEMPORARIO_REMOVER_HISTORICO
AFTER DELETE ON USUARIO_TEMPORARIO
BEGIN
    INSERT INTO HISTORICO_USUARIO_TEMPORARIO(_ROWID, ID, NOME, NOME_DE_USUARIO, EMAIL, PLANO_DE_ASSINATURA, CRIADO_EM, REMOVIDO_EM, VERSAO, BITMASK)
    VALUES (OLD.ROWID, OLD.ID, OLD.NOME, OLD.NOME_DE_USUARIO, OLD.EMAIL, OLD.PLANO_DE_ASSINATURA, OLD.CRIADO_EM, OLD.REMOVIDO_EM, (SELECT COALESCE(MAX(VERSAO), 0) FROM HISTORICO_USUARIO_TEMPORARIO WHERE _ROWID = OLD.ROWID) + 1, -1);
END;
...
BEGIN
    INSERT INTO HISTORICO_EMAIL_AUTENTICACAO(_ROWID, ID, VALOR, TIPO, EXPIRA_EM, USUARIO_TEMPORARIO, VERSAO, BITMASK)
    VALUES (NEW.ROWID, NEW.ID, NEW.VALOR, NEW.TIPO, NEW.EXPIRA_EM, NEW.USUARIO_TEMPORARIO, 1, 31);
END;
...
BEGIN
    ...
    SELECT OLD.ROWID,
           ...
           CASE WHEN OLD.USUARIO_TEMPORARIO != NEW.USUARIO_TEMPORARIO THEN NEW.USUARIO_TEMPORARIO ELSE NULL END,
           ...
           (CASE WHEN OLD.USUARIO_TEMPORARIO != NEW.USUARIO_TEMPORARIO THEN 16 ELSE 0 END);
END;
...
BEGIN
    INSERT INTO HISTORICO_EMAIL_AUTENTICACAO(_ROWID, ID, VALOR, TIPO, EXPIRA_EM, USUARIO_TEMPORARIO, VERSAO, BITMASK)
    VALUES (OLD.ROWID, OLD.ID, OLD.VALOR, OLD.TIPO, OLD.EXPIRA_EM, OLD.USUARIO_TEMPORARIO, (SELECT COALESCE(MAX(VERSAO), 0) FROM HISTORICO_EMAIL_AUTENTICACAO WHERE _ROWID = OLD.ROWID) + 1, -1);
END;
