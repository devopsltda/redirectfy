...
CREATE INDEX IF NOT EXISTS IDX_USUARIO_TEMPORARIO ON USUARIO_TEMPORARIO (ID);
...
CREATE INDEX IF NOT EXISTS IDX_HISTORICO_USUARIO_TEMPORARIO ON HISTORICO_USUARIO_TEMPORARIO (_ROWID);
